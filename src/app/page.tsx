  ...
  return (
    <div className="relative w-28 h-28 sm:w-36 sm:h-36 flex-shrink-0">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <motion.span
          className="text-white text-3xl sm:text-4xl font-black leading-none"
...
function CredentialCard() {
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl p-4 sm:p-6 border border-[#1f1f1f] overflow-hidden"
        ...
        <div className="mb-4 sm:mb-5">
          ...
          <h3 className="text-white text-lg sm:text-xl font-bold leading-tight" style={{ fontFamily: "'Syne', sans-serif" }}>Chidera Obi</h3>
        ...
        <div className="flex items-center gap-4 sm:gap-6 mb-4 sm:mb-5">
          ...
          <div className="space-y-2 sm:space-y-3 flex-1 min-w-0">
            <div>
              ...
              <p className="text-white font-bold text-xl sm:text-2xl" style={{ fontFamily: "'Syne', sans-serif" }}>$38,200</p>
            </div>
            <div>
              <p className="text-[9px] tracking-[0.2em] text-[#333] uppercase">Avg / Month</p>
              <p className="text-[#888] text-sm sm:text-base font-medium">$3,183</p>
            </div>
            <div>
              <p className="text-[9px] tracking-[0.2em] text-[#333] uppercase">Active Since</p>
              <p className="text-[#888] text-xs sm:text-sm">March 2021</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[#161616] pt-3 sm:pt-4 flex items-center justify-between">
          <div>
          ...
          <div className="w-9 h-9 sm:w-10 sm:h-10 bg-white rounded-md p-1 opacity-90">
...
export default function LandingPage() {
  ...
  const handleNavClick = (e: React.MouseEvent, label: string) => {
    e.preventDefault();
    scrollToSection(NAV_IDS[label]);
    setMenuOpen(false);
  };

  return (
    <div className="landing-page-body min-h-screen bg-[#080808] text-white" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {/* NAV */}
      <nav
        className="fixed top-0 left-0 right-0 z-40 px-5 md:px-10 py-4 flex items-center justify-between"
        ...
        <div className="hidden md:flex items-center gap-8">
          {NAV_LINKS.map((l) => (
            <a
              ...
              className="text-sm text-[#555] hover:text-white transition-colors duration-200 tracking-wide cursor-pointer"
            >
              {l}
            </a>
          ))}
              ...
              <div className="flex flex-col px-6 py-8 gap-1 flex-1">
                {NAV_LINKS.map((l, i) => (
                  <motion.a
                    ...
                    onClick={(e) => handleNavClick(e, l)}
                    className="text-base text-[#666] hover:text-white transition-colors py-4 border-b border-[#111] tracking-wide cursor-pointer"
                  >
                    {l}
                  </motion.a>
                ))}
      ...
      {/* HERO */}
      <section className="min-h-screen flex flex-col lg:flex-row items-center gap-10 lg:gap-12 px-5 md:px-10 pt-24 sm:pt-28 pb-16 sm:pb-20 max-w-7xl mx-auto">
        <div className="flex-1 min-w-0 w-full">
          <motion.div
            initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-[#1e1e1e] bg-[#0e0e0e] mb-6 sm:mb-8"
          >
            <motion.div className="w-2 h-2 rounded-full bg-[#C8F135]" animate={{ scale: [1, 1.4, 1] }} transition={{ duration: 2, repeat: Infinity }} />
            <span className="text-[10px] sm:text-[11px] tracking-[0.2em] text-[#555] uppercase">Powered by Solana · Raenest</span>
          </motion.div>
          ...
          <div className="mb-5 sm:mb-6">
            <motion.h1
              ...
              style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(2.4rem, 7vw, 5.5rem)" }}
            >
              Prove your
              <br />
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mb-5 sm:mb-6">
          ...
          <motion.p
            ...
            className="text-[#444] text-sm sm:text-base md:text-lg leading-relaxed max-w-lg mb-8 sm:mb-10 font-light"
          >
          ...
          >
            <Link href="/register">
              <motion.button whileHover={{ scale: 1.04, boxShadow: "0 0 50px rgba(200,241,53,0.2)" }} whileTap={{ scale: 0.96 }}
                className="px-5 sm:px-7 py-3 sm:py-3.5 rounded-full bg-[#C8F135] text-black font-semibold text-sm tracking-wide hover:bg-[#d8ff40] transition-all">
                Mint Your Credential →
              </motion.button>
            </Link>
            <Link href="/verify/demo">
              <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}
                className="px-5 sm:px-7 py-3 sm:py-3.5 rounded-full border border-[#1e1e1e] text-[#555] text-sm hover:border-[#2e2e2e] hover:text-white transition-all">
          ...
          >
            {[{ val: "100%", label: "On-chain" }, { val: "3s", label: "Verify time" }, { val: "0", label: "Forgeries possible" }].map((s) => (
              <div key={s.label}>
                <p className="text-white font-bold text-lg sm:text-xl" style={{ fontFamily: "'Syne', sans-serif" }}>{s.val}</p>
                <p className="text-[#2e2e2e] text-[9px] sm:text-[10px] tracking-widest uppercase">{s.label}</p>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="px-5 md:px-10 py-16 sm:py-24 max-w-5xl mx-auto scroll-mt-20">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 sm:mb-16">
          ...
          <h2 className="font-extrabold leading-tight" style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(1.8rem, 5vw, 3.5rem)" }}>
        ...
        <div className="relative">
          ...
          <div className="space-y-4">
            {STEPS.map((step, i) => (
              ...
              >
                <div className="flex-shrink-0 w-14 sm:w-20 flex items-start justify-center pt-5">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-[#1a1a1a] flex items-center justify-center text-xs text-[#333] group-hover:border-[#C8F135] group-hover:text-[#C8F135] transition-all duration-300"
                    style={{ fontFamily: "'DM Mono', monospace" }}>
                    {step.num}
                  </div>
                </div>
                <div className="flex-1 border border-[#111] rounded-xl p-4 sm:p-6 hover:border-[#1e1e1e] hover:bg-[#0a0a0a] transition-all duration-300 group-hover:translate-x-1">
                  <h3 className="text-white font-semibold text-base sm:text-lg mb-2" style={{ fontFamily: "'Syne', sans-serif" }}>{step.title}</h3>
      ...
      {/* FEATURES */}
      <section id="features" className="px-5 md:px-10 py-16 sm:py-24 max-w-5xl mx-auto scroll-mt-20">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 sm:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {FEATURES.map((f, i) => (
            <motion.div
              ...
              className="group p-5 sm:p-6 border border-[#111] rounded-xl hover:border-[#1e1e1e] hover:bg-[#0a0a0a] transition-all duration-300 cursor-default"
            >
      ...
      {/* VERIFY SECTION */}
      <section id="verify" className="px-5 md:px-10 py-16 sm:py-24 max-w-5xl mx-auto scroll-mt-20">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 sm:mb-16">
          <p className="text-[11px] tracking-[0.3em] text-[#C8F135] uppercase mb-4">Verification</p>
          <h2 className="font-extrabold leading-tight" style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(1.8rem, 5vw, 3.5rem)" }}>
            Trust in<span className="text-[#222]"> seconds.</span>
          </h2>
        </motion.div>
          ...
          {[
            {
              icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M11 4H16V9" stroke="#C8F135" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M16 4L9 11" stroke="#C8F135" strokeWidth="1.5" strokeLinecap="round"/>
                  <path d="M8 5H4C3.44772 5 3 5.44772 3 6V16C3 16.5523 3.44772 17 4 17H14C14.5523 17 15 16.5523 15 16V12" stroke="#C8F135" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              ),
              title: "Share a link",
              body: "Copy your unique credential URL and send it to anyone — visa officer, bank, or client."
            },
            {
              icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <rect x="3" y="3" width="5" height="5" rx="1" stroke="#C8F135" strokeWidth="1.5"/>
                  <rect x="12" y="3" width="5" height="5" rx="1" stroke="#C8F135" strokeWidth="1.5"/>
                  <rect x="3" y="12" width="5" height="5" rx="1" stroke="#C8F135" strokeWidth="1.5"/>
                  <rect x="12" y="12" width="2" height="2" fill="#C8F135"/>
                  <rect x="15" y="12" width="2" height="2" fill="#C8F135"/>
                  <rect x="12" y="15" width="2" height="2" fill="#C8F135"/>
                  <rect x="15" y="15" width="2" height="2" fill="#C8F135"/>
                  <rect x="4.5" y="4.5" width="2" height="2" fill="#C8F135"/>
                  <rect x="13.5" y="4.5" width="2" height="2" fill="#C8F135"/>
                  <rect x="4.5" y="13.5" width="2" height="2" fill="#C8F135"/>
                </svg>
              ),
              title: "Scan a QR code",
              body: "Your credential card includes a QR code that opens the verification page instantly on any device."
            },
            {
              icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <circle cx="10" cy="10" r="7.5" stroke="#C8F135" strokeWidth="1.5"/>
                  <polyline points="6.5,10 9,12.5 13.5,7.5" stroke="#C8F135" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              ),
              title: "Verified on-chain",
              body: "Anyone who opens the link sees your earnings, score, and on-chain proof. No login. No friction."
            },
          ].map((item, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
              className="p-5 sm:p-6 border border-[#111] rounded-xl hover:border-[#1e1e1e] hover:bg-[#0a0a0a] transition-all duration-300"
            >
              <div className="mb-4 w-9 h-9 rounded-lg border border-[#1a1a1a] flex items-center justify-center" style={{ background: "#0a0a0a" }}>
                {item.icon}
              </div>
              <h3 className="text-white font-semibold text-base mb-2" style={{ fontFamily: "'Syne', sans-serif" }}>{item.title}</h3>
        ...
        >
          <Link href="/verify/demo">
            <motion.button
              ...
              className="px-7 py-3.5 rounded-full border border-[#1e1e1e] text-[#555] text-sm hover:border-[#C8F135]/30 hover:text-[#C8F135] transition-all"
            >
              View a sample credential →
            </motion.button>
          </Link>
        </motion.div>
      </section>
      ...
      {/* CTA */}
      <section className="px-5 md:px-10 py-16 sm:py-24 max-w-5xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="relative rounded-2xl overflow-hidden border border-[#1a1a1a] p-8 sm:p-10 md:p-16 text-center"
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-36 sm:w-48 h-36 sm:h-48 opacity-5 pointer-events-none"
            style={{ background: "radial-gradient(circle at bottom left, #C8F135, transparent 70%)" }} />
          <p className="text-[11px] tracking-[0.3em] text-[#C8F135] uppercase mb-4 sm:mb-5">Start today</p>
          <h2 className="font-extrabold leading-tight mb-4 sm:mb-5" style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(1.8rem, 5vw, 3.5rem)" }}>
            Your work is real.
            <br /><span className="text-[#222]">Now make it provable.</span>
          </h2>
          <p className="text-[#444] text-sm leading-relaxed max-w-md mx-auto mb-6 sm:mb-8">
          ...
          <Link href="/register">
            <motion.button
              ...
              className="px-7 sm:px-9 py-3.5 sm:py-4 rounded-full bg-[#C8F135] text-black font-semibold text-sm tracking-wide hover:bg-[#d8ff40] transition-all"
            >
